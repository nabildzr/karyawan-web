...
export default function NotFound() {
  ...
  // % murni dari role
  // const canAccessAdminByRole = user?.rbacRole?.canAccessAdmin === true;
  
  const canAccessAdmin = canAccessAdminPortal;

  // const whereToGo = canAccessAdmin? "/admin/dashboard" : "/";

  const [whereToGo, setWhereToGo] = useState("/karyawan");

  useEffect(() => {
    if (canAccessAdmin) {
      setWhereToGo("/admin/dashboard");
    } 
  }, [canAccessAdmin])
