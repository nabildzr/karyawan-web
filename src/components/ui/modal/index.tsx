...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-y-auto modal z-99999">
      {!isFullscreen && (
        <div
          className={`fixed inset-0 h-full w-full bg-blue-900/10 backdrop-blur-[16px] transition-opacity duration-200 ${
      ...
      <div
        ref={modalRef}
        className={`${contentClasses} ${className} transition-all duration-200 ${
          animating
